...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine($"Age: {employee.Age} FirstName: {employee.FirstName} YOE: {employee.YearsOfExperience}");
            }
            ...
            employees = employees.Append(new Employee("first", "lastName", 39, 1)).ToList();
